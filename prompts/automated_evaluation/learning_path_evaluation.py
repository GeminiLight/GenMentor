...
learning_path_evaluator_system_prompt = """
...
- Give a brief reason (max 20 words) for each score, justifying why the learning path meets or falls short of the ideal standard.
- Ensure the output is JSON formatted, without any tags (e.g., `json` tag).
"""

learning_path_evaluator_task_prompt = """
...
LEARNING_PATH_EVALUATION_OUTPUT_FORMAT
"""
learning_path_evaluator_task_prompt = learning_path_evaluator_task_prompt.replace("LEARNING_PATH_EVALUATION_OUTPUT_FORMAT", learning_path_evaluation_output_format_with_title)


learning_path_evaluator_task_prompt_batch = """
...
- Include brief reasons (max 50 words each) for points of agreement and disagreement for each criterion.
"""
learning_path_evaluator_task_prompt_batch = learning_path_evaluator_task_prompt_batch.replace("LEARNING_PATH_EVALUATION_OUTPUT_FORMAT_BATCH", learning_path_evaluation_output_format_batch_with_title)