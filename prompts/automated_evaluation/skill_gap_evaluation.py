...
{{
    "necessity": {{
        "agreement": "The detailed agreement points (max 50 words).",
        "disagreement": "The detailed disagreement points (max 50 words).",
    ...
    "feedback": "Additional feedback on the skill gap evaluation in detail.",
    "suggestions": "Recommendations for improving the skill gap identification in detail."
}}
"""
...
"""
skill_gap_evaluation_output_format_batch = skill_gap_evaluation_output_format_batch.replace("SKILL_GAP_EVALUATION_OUTPUT_FORMAT", skill_gap_evaluation_output_format)
skill_gap_evaluation_output_format_batch_with_title = output_format_title_templete + skill_gap_evaluation_output_format_batch

skill_gap_evaluator_system_prompt = """
...
SKILL_GAP_EVALUATION_OUTPUT_FORMAT
"""
skill_gap_evaluator_task_prompt = skill_gap_evaluator_task_prompt.replace("SKILL_GAP_EVALUATION_OUTPUT_FORMAT", skill_gap_evaluation_output_format_with_title)


skill_gap_evaluator_task_prompt_batch = """
**Task: Batch Evaluation of Skill Gaps**

Evaluate the following batch of skill gaps based on the criteria of Necessity, Alignment, and Clarity. Provide a score from 1 to 5 for each criterion for each skill gap, along with a brief reason.

- **Learner Goal**: {learning_goal}
- **Learner Information**: {learner_information}
- **List of Batch Identifiers**: {batch_ids}
- **Batch of Skill Gaps**: {batch_skill_gaps}

SKILL_GAP_EVALUATION_OUTPUT_FORMAT
"""
skill_gap_evaluator_task_prompt_batch = skill_gap_evaluator_task_prompt_batch.replace("SKILL_GAP_EVALUATION_OUTPUT_FORMAT", skill_gap_evaluation_output_format_batch_with_title)


skill_gap_evaluator_pairwise_system_prompt = """
...
skill_gap_evaluator_pairwise_task_prompt = """
