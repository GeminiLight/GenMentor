...
{{
    "necessity": {{
        ...
        "explanation": "Brief reason for the necessity score (max 50 words)."
    }},
    "completeness": {
        "score": completeness_score,
        "explanation": "Brief reason for the completeness score (max 50 words)."
    }},
...
{{
    ...
    "alignment": {{
        ...
        "explanation": "Points of agreement (max 50 words)."
    }},
...
- Rate each skill on a scale from 1-5.
...
**Output Template**
"""
goal2skill_mapping_scorer_task_prompt_scoring += goal2skill_mapping_evaluation_scoring_output_format
...
"""
goal2skill_mapping_scorer_task_prompt_batch_scoring = goal2skill_mapping_scorer_task_prompt_batch_scoring.replace("GOAL2SKILL_MAPPING_EVALUATION_BATCH_SCORING_OUTPUT_FORMAT", goal2skill_mapping_evaluation_batch_scoring_output_format_with_title)
...
GOAL2SKILL_MAPPING_EVALUATION_VALIDATION_OUTPUT_FORMAT
"""
goal2skill_mapping_scorer_task_prompt_validation = goal2skill_mapping_scorer_task_prompt_validation.replace("GOAL2SKILL_MAPPING_EVALUATION_VALIDATION_OUTPUT_FORMAT", goal2skill_mapping_evaluation_validation_output_format_with_title)
...
"""
goal2skill_mapping_scorer_task_prompt_batch_validation = goal2skill_mapping_scorer_task_prompt_batch_validation.replace("GOAL2SKILL_MAPPING_EVALUATION_BATCH_VALIDATION_OUTPUT_FORMAT", goal2skill_mapping_evaluation_batch_validation_output_format_with_title)